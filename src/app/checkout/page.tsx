  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full flex-col overflow-x-hidden pb-32 bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display antialiased">
      ...
      <header className="sticky top-0 z-40 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-xl px-4 pb-4 pt-10 flex items-center justify-between border-b border-slate-100 dark:border-slate-800/50">
        ...
        <h2 className="text-xs font-black tracking-[0.3em] uppercase italic text-slate-900 dark:text-white flex-1 text-center pr-10">
            {step === 'details' ? 'Datos y Entrega' : 'Pago'}
        </h2>
      </header>
                                    ...
                                    <label className="group cursor-pointer">
                                        ...
                                        <div className="flex items-center gap-3 p-4 rounded-3xl bg-white dark:bg-slate-800 border-2 border-transparent peer-checked:border-primary peer-checked:bg-primary/5 transition-all shadow-sm">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Retiro por tienda local</p>
                                            </div>
                                            <div className="text-[9px] font-black uppercase text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-lg">Gratis</div>
                                        </div>
                                    </label>
                                    ...
                                    <label className="group cursor-pointer">
                                        ...
                                        <div className="flex items-center gap-3 p-4 rounded-3xl bg-white dark:bg-slate-800 border-2 border-transparent peer-checked:border-primary peer-checked:bg-primary/5 transition-all shadow-sm">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Retiro sin contacto 24/7</p>
                                            </div>
                                            <div className="text-[9px] font-black uppercase text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-lg">Gratis</div>
                                        </div>
                                    </label>
                                    ...
                                    <label className="group cursor-pointer">
                                        ...
                                        <div className="flex items-center gap-3 p-4 rounded-3xl bg-white dark:bg-slate-800 border-2 border-transparent peer-checked:border-secondary peer-checked:bg-secondary/5 transition-all shadow-sm relative overflow-hidden">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Te lo llevamos a tu vehículo</p>
                                            </div>
                                            <div className="text-[9px] font-black uppercase text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-lg">Gratis</div>
                                        </div>
                                    </label>
                                    ...
                                    <label className="group cursor-pointer">
                                        ...
                                        <div className="flex items-center gap-3 p-4 rounded-3xl bg-white dark:bg-slate-800 border-2 border-transparent peer-checked:border-primary peer-checked:bg-primary/5 transition-all shadow-sm">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Entrega en 2 a 4 días</p>
                                            </div>
                                            <div className="text-xs font-black italic">+$8.500</div>
                                        </div>
                                    </label>
                                </div>
                            </div>
